...
class ParseLocation extends ConfigIP {
      ...
      if (response.statusCode == 200) {
        ...
        if (plan == "plus" || plan == "security") {
          ...
          data.country.currency.symbol =
              ip2loc!["country"]["currency"]["symbol"];
          ...
          data.region.translation.lang =
              ip2loc!["region"]["translation"]["lang"];
          data.region.translation.value =
              ip2loc!["region"]["translation"]["value"];
          ...
          data.timeZoneInfo.currentTime =
              ip2loc!["time_zone_info"]["current_time"];
        ...
        if (plan == "security") {
          ...
          data.proxy.isResidentialProxy =
              ip2loc!["proxy"]["is_residential_proxy"];
        ...
        ip2loc = jsonDecode(response.body);
        data.errorStatusCode = ip2loc!["error"]["error_code"];
        data.errorReasonPhrase = ip2loc!["error"]["error_message"];
        return data;
      }
  ...
  void _extractDataFromJson(
      HttpIkaWhoisService data, Map<String, dynamic> json) {
